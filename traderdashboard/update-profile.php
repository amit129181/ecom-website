...
include "../config.php";
        ...
        if(isset($_FILES['fileName'])){
                ...
                $sql = "UPDATE `trader` SET `trader_name` = '$name', `email` = '$email', `phone_no` = '$phone', `trader_description` = '$desc', image='$file_name' WHERE `trader_id` = '$id'";
        
        $query=mysqli_query($conn,$sql) or die("Record not updated");
