                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <?php if(isset($_SESSION['username'])){
                                ...
                                ?>
                            <a class="nav-link active text-center " href="customer_profile.php"><img
                                    src="<?php echo $image ?>" class="mr-1 rounded-circle" alt="">Hi
                                <?Php echo $customer_name?>
                            </a>
                            <?php   }?>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-center cart-item-basket mb-md-0 mb-2" href="cart.php"><i
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active text-center" href="#" id="navbarDropdown" role="button"
                                ...
                                More<i class="fas fa-angle-down mr-1"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <?php if(isset($_SESSION['username'])){ ?>
                                <a class="dropdown-item m-0" href="customer_profile.php">Profie Setting</a>
                                <?php }?>
                                <?php if(!isset($_SESSION['username'])){ ?>
                                <a class="dropdown-item m-0" href="register.php">Register</a>
                                <?php }?>
                                <?php if(!isset($_SESSION['username'])){ ?>
                                <a class="dropdown-item m-0" href="login.php">Login</a>
                                <?php }?>
                                <?php if(isset($_SESSION['username'])){ ?>
                                <a class="dropdown-item m-0" href="logout.php">Logout</a>
                                <?php }?>
                            </div>
                        </li>
                    </ul>
